...
let Spielerkartenarray = [];
let Pckartenarray = [];
let kartenzieharray = [rot1, rot2, rot3, rot4, rot5, rot6, rot7, rot8, blau1, blau2, blau3, blau4, blau5, blau6, blau7, blau8, gelb1, gelb2, gelb3, gelb4, gelb5, gelb6, gelb7, gelb8, lila1, lila2, lila3, lila4, lila5, lila6, lila7, lila8, rot1, rot2, rot3, rot4, rot5, rot6, rot7, rot8, blau1, blau2, blau3, blau4, blau5, blau6, blau7, blau8, gelb1, gelb2, gelb3, gelb4, gelb5, gelb6, gelb7, gelb8, lila1, lila2, lila3, lila4, lila5, lila6, lila7, lila8];
let ablagekartenarray = [];
function run() {
...
function startgame() {
    switch (j) {
        case 1: {
            let ziehKarten = document.createElement("div");
...
function zeigeKarteSpieler() {
    ...
    for (let i = 0; i <= Spielerkartenarray.length - 1; i++) {
...
function zeigeKartePC() {
    ...
    console.log("chabbos wissen wer der babbo ist ;)");
    for (let i = 0; i <= Pckartenarray.length - 1; i++) {
        let newCard = document.createElement("img");
        newCard.innerHTML = "";
...
function spielekarte(event) {
    console.log(event.target);
    let t = ablagekartenarray.length - 1;
    let kartenclick = event.target;
    let kartenfarbe = kartenclick.alt;
    let kartennummer = kartenclick.id;
    let position = parseInt(kartenclick.className);
...
function Pcspieltkarte() {
    let t = true;
    for (let i = 0; i < Pckartenarray.length; i++) {
